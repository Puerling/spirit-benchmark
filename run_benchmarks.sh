...
python3 run_llg.py $input_sk_with_ddi $initial_image_sk ./benchmark_sk_with_ddi.json
python3 run_llg.py $input_sk_no_ddi $initial_image_sk ./benchmark_sk_no_ddi.json
python3 run_llg.py $input_hopfion $initial_image_hopf ./benchmark_hop.json
